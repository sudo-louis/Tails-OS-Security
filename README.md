...
- Instalación automatizada de herramientas comunes de ciberseguridad.
- Compatible con el entorno Tails.
- Pensado para uso temporal en entornos efímeros (ejecución en live sessions).

## 🧪 Uso

1. Al ingresar en Tails habilita una contraseña para root, necesitarás una terminal root.

2. Descarga el archivo script.sh y dale permisos de ejecución chmod +x script.sh
